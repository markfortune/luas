...
def transit_light_curve(mf_params, x_l, x_t):
...
transit_light_curve_vmap = jax.jit(jax.vmap(transit_light_curve, in_axes=({"T0":None, "P":None, "a":None, "rho_2":0, "b":None, "c1":0, "c2":0, "Foot":0, "Tgrad":0}, 0, None), out_axes = 0))
...
def transit_2D(p, x_l, x_t):
    ...
    return transit_light_curve_vmap(mfp, x_l, x_t)
