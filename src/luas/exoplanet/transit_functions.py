...
def transit_light_curve(mfp, x_t):
...
transit_light_curve_vmap = jax.jit(jax.vmap(transit_light_curve, in_axes=({"T0":None, "P":None, "a":None, "rho":0, "b":None, "c1":0, "c2":0, "Foot":0, "Tgrad":0}, None), out_axes = 0))
...
def transit_2D_multi_x_t(p, x_l, x_t):
    transit_params = ["T0", "P", "a", "rho", "b", "c1", "c2", "Foot", "Tgrad"]
...
def transit_param_transform(p_vary, p_fixed, log_params):
